...
7. Click **Add+**, then select **File Upload** from the list. 
...
9. Click **Save** to create the datasource.

<br>

Now we need to run a job in order to ingest the data into Fusion.

10. Click **Run**, then click **Start** in the job window to start the job.
...
11. Once the job is complete, click the **X** to close the dialog.
...
12.  In the left navigation pane, click **Indexing**, then select **Index Workbench** from the list.

<img src="https://storage.googleapis.com/fusion-datasets/LabScreenshots_5.7/navigation/nav_indexing.png" style="height: 300px; width:200px;"/>

<br>
   
13.  In the top right corner, click **Load**, then select **shoes** from the list.
...
14. In the left navigation pane, click **Collections**, then select **Fields** from the list.
...
15. In the Fields pane, click **Add a Field+**, then enter the following values:
...
16. Click **Save** to create the ```item-data``` field.
...
17. Click **Add a Field** again, and enter the following values:
...
18. Click the green plus next to **+ Copy Fields to**. 
* In the **Copy Fields To** field, select the ```item-data``` option.

19. Click **Save** to create the ```brand``` field.
...
20.  Find and return to the **Datasources** tab and open the **shoes** datasource.

21.  Click **Clear Datasource**, then click **Yes, clear** to confirm the action.
