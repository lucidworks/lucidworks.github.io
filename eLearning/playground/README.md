...
* **Hardware Supplies:** A vast collection mirroring a physical hardware store, encompassing tools, screws, and various other common supplies, facilitating experimentation with diverse product categories.

### What you can do

In this secure application, you have the ability to:

* Create, modify, and delete query pipeline stages.
* Work in the Query Workbench. 
* Use the rules editor to create business rules, synonyms, misspelling corrections, and more. 
* Play with Predictive Merchandiser to curate the ideal e-commerce experience.
